...
training_idx = np.load('/scratch/users/kashefi/DiffCFD/training_idx.npy')
validation_idx = np.load('/scratch/users/kashefi/DiffCFD/validation_idx.npy')
test_idx = np.load('/scratch/users/kashefi/DiffCFD/test_idx.npy')
